...
#output: the object produced by jags.samples from the MCMC run
    ...
    jm <- jags.model('fieldrandom.bug',data = list('field' = as.vector(field),'y' = y,'N' = length(y),'K' = ncat, a.mu=priormvn$a.mu,a.T=priormvn$a.T, 'field.vmax' = field.vmax, 'nfield' = nfield),
